// Title: MainMenuManager.cs
// Description: script to manage all the main menu movement and activities
...
public class MainMenuManager : MonoBehaviour {
	...
	public int startLives = 2; // how many lives to start the game with on New Game
